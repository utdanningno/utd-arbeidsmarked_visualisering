...
export function getData(_x, _x2, _x3) {
  return _getData.apply(this, arguments);
}
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, direction, api_url) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          mainEndpoint = api_url + '/sammenligning/main';
          endpoint = api_url + '/sammenligning/arbeidsmarked';
          idNames = {
            "uno_id2nus": "uno_id",
...
export function useData(unoId, direction, api_url) {
  if (unoId === void 0) {
    unoId = "y_sykepleier";
  }
  if (direction === void 0) {
