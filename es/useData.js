...
export var getData = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(id, direction) {
    var mainEndpoint, endpoint, idNames, url, mapping, main, docs, mappingData;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            mainEndpoint = "https://api.utdanning.no/legacy-sammenligning/main";
            endpoint = "https://api.utdanning.no/legacy-sammenligning/arbeidsmarked";
            idNames = {
              "uno_id2nus": "uno_id",
