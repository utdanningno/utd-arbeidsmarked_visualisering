...
exports.getColor = exports.defaultColors = exports.useResize = undefined;
...
var useResize = exports.useResize = function useResize(viz, width, setWidth) {
...
var getColor = exports.getColor = function getColor(id, colors) {
  if (!id) {
    return colors.other;
