...
var Visualization = function Visualization(_ref) {
  ...
  var tooltip = (0, _utils.useTooltip)({ container: viz });
    ...
    _react2.default.createElement(
      ...
      datapoints.map(function (subItem, i) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_framerMotion.motion.rect, {
            x: 0,
            y: i * itemHeight,
            width: width,
            height: itemHeight,
          ...
          _react2.default.createElement(
            _framerMotion.motion.foreignObject,
            {
              fontSize: "14",
...
Visualization.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  layout: _propTypes2.default.oneOf(["bars", "tree"]),
  treeGutter: _propTypes2.default.number,
  disaggregate: _propTypes2.default.bool,
